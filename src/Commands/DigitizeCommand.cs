...
namespace RevitMCPBridge.Commands
{
    ...
    public class DigitizeCommand : IExternalCommand
    {
        ...
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            try
            {
                ...
                {
                    TaskDialog.Show("Digitize Footprint", "BIM Monkey API key not found. Open Banana Chat and complete setup first.");
                ...
                LaunchAgentCommand.GetPanel()?.PreloadDigitizePrompt(dialog.Result);

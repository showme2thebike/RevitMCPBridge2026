...
namespace RevitMCPBridge.Commands
{
    ...
    internal class FaqWindow : Window
    {
        ...
        private static string BuildHtml()
        {
            ...
            html.AppendLine("<p class='step'><span class='step-num'>2.</span> Confirm the BIM Monkey installer has finished — it installs Node.js and Claude Code automatically. Items already on your machine are skipped.</p>");
            ...
            html.AppendLine("<p class='a'>Under the hood it runs Claude Sonnet 4.6 with access to over 1,100 Revit endpoints. You control the conversation — start generation, change course mid-session, ask follow-up questions, and fix problems without leaving Revit.</p>");
            ...
            html.AppendLine("<p class='q'>How does Banana Chat reference my firm's library during generation?</p><p class='a'>When you start a generation session, Banana Chat uses a headless Chromium browser (installed silently by the BIM Monkey installer) to open your firm's approved drawing library at app.bimmonkey.ai. It screenshots the library pages and uses them as a visual reference throughout generation — matching your sheet layout, numbering format, and detail style to drawings your firm has already approved. No browser window appears; it all happens in the background.</p>");
            ...
            html.AppendLine("<p class='q'>Start Server (Server Control panel)</p><p class='a'>Starts the BIM Monkey MCP server — the named pipe that gives Banana Chat access to over 1,100 Revit endpoints. Must be clicked before your first session. Restarts automatically when you open a new project.</p>");
            ...
            html.AppendLine("<p class='step'><span class='step-num'>1.</span> In the BIM Monkey ribbon, click <strong>Banana Chat</strong> → gear icon → confirm your BIM Monkey API key is saved. The key starts with <code>bm_</code> and was emailed on signup.</p>");

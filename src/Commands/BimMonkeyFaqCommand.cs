...
namespace RevitMCPBridge.Commands
{
    ...
    internal class FaqWindow : Window
    {
        ...
        private static string BuildHtml()
        {
            ...
            html.AppendLine("<p class='step'><span class='step-num'>5.</span> Click <strong>Start Generation</strong> in the Documentation panel. Claude Code opens automatically, reads your model through the BIM Monkey plugin, calls the backend to build a CD plan from your firm's training library, and executes it directly in Revit.</p>");
            html.AppendLine("<p class='step'><span class='step-num'>6.</span> Claude executes the plan in three phases: <strong>Phase 1</strong> — sheets and view placements; <strong>Phase 2</strong> — section and assembly details; <strong>Phase 3</strong> — door schedule, window schedule, room finish schedule, and keynote legend.</p>");

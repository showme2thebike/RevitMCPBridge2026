...
namespace RevitMCPBridge.Commands
{
    ...
    public class PermitsCommand : IExternalCommand
    {
        ...
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            try
            {
                ...
                {
                    TaskDialog.Show("Permit History", "BIM Monkey API key not found. Open Banana Chat and complete setup first.");
                ...
                var dialog = new PermitHistoryDialog(defaultAddress, bmKey, RailwayUrl);

        ...
        public void PreloadDigitizePrompt(RevitMCPBridge.Commands.ParcelResult parcel)
        {
            try
            {
                ...
                var prompt =
                    ...
                    "STAGE 3 — photos: FIRST load getKnowledgeFile('photo-metrology.md') and follow its anchor/counting protocol. Then lookupZillowPhotos for the address and analyze exterior photos with analyzeImage (3-4 URLs per call): story count (count siding courses/brick coursing), roof form, cladding, and an opening schedule with anchored dimensions (entry door = 80\" height anchor). Count risers on any visible stair to derive the true floor-to-floor height.\n\n" +
